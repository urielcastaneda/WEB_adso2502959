...
-- 
-- En caso de requerir eliminar la BD actual y crear una nueva...
-- de lo contrario dejar los comentarios en este bloque de instrucciones
-- DROP DATABASE IF EXISTS `BDADSI2251833`;
CREATE DATABASE IF NOT EXISTS `BDADSI2251833` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;

-- Ubicamos el control en la BD requerida
USE `BDADSI2251833`;
...
CREATE TABLE  IF NOT EXISTS departamento (
          codDepto     char (2)  PRIMARY KEY,
          nombreDpto   varchar (30) NOT NULL,
          codCapital   char (5)
)
ENGINE=INNODB  DEFAULT CHARSET=UTF8MB4;

-- Aquí insertamos todos los registros
INSERT INTO departamento (codDepto, nombreDpto, codCapital) VALUES 
('05','Antioquia','05001'),
('08','Atlántico','08001'),
('11','Bogotá, D.C.','11001'),
('13','Bolívar','13001'),
...
('50','Meta','50001'),
('52','Nariño','52001'),
('54','Norte De Santander','54001'),
('63','Quindio','63001'),
('66','Risaralda','66001'),
('68','Santander','68001'),
('70','Sucre','70001'),
('73','Tolima','73001'),
('76','Valle Del Cauca','76001'),
('81','Arauca','81001'),
('85','Casanare','85001'),
('86','Putumayo','86001'),
('88','San Andrés y Providencia','88001'),
('91','Amazonas','91001'),
('94','Guainía','94001'),
('95','Guaviare','95001'),
('97','Vaupés','97001'),
...
--  HASTA AQUÍ LA CREACIÓN DE LA TABLA DE DEPARTAMENTOS 

-- TABLA DE MUNICIPIOS
-- Primero verificamos si existe y la borramos en caso que exista
-- DROP TABLE IF EXISTS municipio CASCADE;

-- Creación de la tabla Municipio
CREATE TABLE  IF NOT EXISTS municipio (
	codMunicipio CHAR(5) NOT NULL PRIMARY KEY,
	nombreMunicipio VARCHAR(50) NOT NULL,
	codDepto CHAR(2) NOT NULL,
...
-- Aquí insertamos todos los registros
INSERT INTO municipio (codMunicipio, nombreMunicipio, codDepto) VALUES 
('05001','Medellín','05'),
('05002','Abejorral','05'),
('05004','Abriaquí','05'),
('05021','Alejandría','05'),
...
-- para hacer alusión a la capital, la cual debe existir en la tabla municipio
-- ALTER TABLE  departamento
-- ADD CONSTRAINT FK_codCapital
-- FOREIGN KEY (codCapital) REFERENCES  municipio (codMunicipio);

ALTER TABLE departamento
  ADD CONSTRAINT IF NOT EXISTS FK_codCapital
    FOREIGN KEY(codCapital) REFERENCES municipio(codMunicipio);
